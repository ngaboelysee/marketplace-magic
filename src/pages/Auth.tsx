        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="bg-card border border-border rounded-2xl p-8">
            ...
            <div className="flex mb-8">
              <button
                className={`flex-1 pb-3 text-sm font-medium border-b-2 transition-colors ${
                  isLogin 
                    ? "border-luxe-gold text-foreground" 
                  ...
                  <button
                    className={`p-4 rounded-lg border-2 text-left transition-colors ${
                      userType === "customer"
                        ...
                        : "border-border hover:border-luxe-gold/50"
                    }`}
            ...
            <form className="space-y-4">
              ...
              <Button variant="luxe" className="w-full" type="submit">
            ...
            {!isLogin && userType === "seller" && (
              <p className="text-xs text-muted-foreground text-center mt-6">
                Want to set up your business profile?{" "}
                <Link to="/sell" className="text-luxe-gold hover:underline">
          ...
          <p className="text-xs text-muted-foreground text-center mt-6">
            ...
            <Link to="/terms" className="text-luxe-gold hover:underline">Terms of Service</Link>
            {" "}and{" "}
            <Link to="/privacy" className="text-luxe-gold hover:underline">Privacy Policy</Link>
          </p>
        </div>
      </main>
      <Footer />
